...
export default function ResetPassword() {
    ...
    const initialValues = {
      ...
      const validationSchema = Yup.object({
        ...
        newPassword: Yup.string().required('Password is required').min(6, 'Password must be at least 6 characters').matches(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{3,}$/, 'Password must contain at least one letter and one number'),      
    })
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      isInvalid={errors.newPassword && touched.newPassword} errorMessage={errors.newPassword}
      label="newPassword"
      type= "Password"
      variant='bordered'
      name='newPassword'
